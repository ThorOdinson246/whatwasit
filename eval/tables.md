...
|---|---:|---:|---:|---:|---:|---:|---:|
| semantic | 0.419 | 0.229 | 0.177 | 0.884 | 0.953 | 0.596 | 0.656 |
...
| cron-setup (sem) | 2 | 0.50 | 0.17 | 0.10 | 0.50 | 1.00 | 0.57 | 0.50 |
...
| perm-chmod (sem) | 2 | 0.50 | 0.33 | 0.20 | 1.00 | 1.00 | 0.67 | 0.75 |
...
| rsync-sync (sem) | 2 | 0.50 | 0.17 | 0.10 | 0.50 | 0.50 | 0.55 | 0.50 |
...
| python3 -m venv activate pip install requirements.txt | python_venv_setup | 1 | python_venv_setup:0.0328<br>python_import_error:0.0323<br>python_dependency_conflict:0.032 | 1 |
| git filter-branch --force git rm --cached secrets.env reflog gc prune | git_large_file_purge | 1 | git_large_file_purge:0.0328<br>git_undo_commit:0.0323<br>find_large_old_files:0.032 | 1 |
